...
1. **INTEL SUFFICIENCY** (hard gate — check FIRST)
   ...
   **Generic = NOT sufficient:** school name, city, enrollment, address, years in operation, contact's role/title, grade levels served, school type (Catholic, charter, public). These are directory data. Anyone can look them up. They are NOT intel.
   **Non-generic = sufficient:** a specific initiative or program the school runs, a stated problem or concern, a recent news mention, a social media post, a recent hire or departure, a community event, a policy change, a budget action, a linked factlet about their segment. Something that proves you DID RESEARCH, not just read their address.
   PASS: draft contains at least one fact that could NOT be found in a school directory listing
...
2. **SPECIFICITY**
   ...
   FAIL: "many [role type] tell us..." / "companies like yours often face..." / only uses the school name and location as the "specific" reference
...
5. **TONE AND FORMAT** (replaces old BREVITY — now includes tone checks)
   ...
   **Automatic FAIL triggers — ANY of these = instant brewing:**
   ...
   - Does NOT close with: `Can I show it to you over Zoom?` This is the ONLY permitted closing line.
   ...
   - **CONFRONTATIONAL / NEGGING TONE:** Takes a positive thing about the school and then questions, undermines, or challenges it. Examples of BANNED patterns:
     ...
     - Any sentence that praises the school then pivots to what they're missing or failing at
   - The draft must be WARM and COLLEGIAL, never adversarial. Mention what you found. Connect it to the product. Ask for the meeting. That's it. Do not audit, question, or challenge what the school is doing.
